...
class Duobac implements Stringable
{
    #[ORM\Id]
    ...
    private bool $puc_cod_capacite;
    #[ORM\Column(type: 'string', length: 5, nullable: true)]
    private ?string $pur_cod_clef = null;
    #[ORM\Column(type: 'boolean', nullable: true)]
    private bool|null $puc_cod_dechet;
    ...
    public function __construct(#[ORM\Column(type: 'string', length: 15, nullable: false)] private ?string $rdv_matricule, #[ORM\Column(type: 'string', length: 30, nullable: false)] private ?string $puc_no_puce)
    {
